...
include("config.php");
session_start();
if(isset($_SESSION['eid']) && isset($_REQUEST['itemno'])){
$id=$_SESSION['eid'];
...
if(isset($_REQUEST['send']))
 ...
 if(mysqli_query($con,"insert into orders values('$pname','$itemno','$price','$size','$uname','$ac_no','$mob_no','$add','$bank','$city','$order_no')"))
    {
...
<body>
<div>
<div><br/><center><h2><font face="Times New Roman" size="+1" >Welcome 
<?php
$sel=mysqli_query($con,"select * from register where id='$id'");
  $arr=mysqli_fetch_array($sel);
  echo $arr['title']."&nbsp;".$arr['fname'];
?>
</font></h2></center>
<h2 align="right"><a href="?log=out"><font >LogOut</font></a></h2>
</div>
...
<center><h2><font face="Times New Roman" size="+1" >Order Form</font></h2></center>
<fieldset style="background:#CC99CC;width:50%">
<br><br>
	<?php
	$sel=mysqli_query($con,"select * from items where itemno='$itemno'");
