...
if($_REQUEST['sub'])
  {
    if(mysqli_query($con,"insert into items  values('$catg','$subcatg','$img','$itemno','$price','$desc','$t','') "))
	   {
...
<body>
<br><br><br>
<center><font color="#000000" size="+3">Add Item</font></center>
<br><br>
<center><fieldset style="background:#FFFFFF;width:50%">
