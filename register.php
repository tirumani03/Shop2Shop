...
if($_REQUEST['sub'])
{
$sel=mysqli_query($con,"select id from register where id='$id' ");
$arr=mysqli_fetch_array($sel);

if($arr['id']!=$id)
  {
   if(mysqli_query($con,"insert into register values('$title','$fname','$lname','$gen','$id','$pass','$phone','$add','$city','$coun','$dob')"))
	   {
...
<div><br/><center><h2><font face="Times New Roman" size="+1" color="#0a8d87">Register New User</font></h2></center></div>
<div>
...
<table width="366" border="0" align="center">
  ...
  <tr>
    <td><div align="center"><strong><font size="+1" face="Times New Roman">Title:</font></strong></div></td>
    <td><label>
  ...
  <tr>
    <td width="164"><div align="center"><font size="+1" face="Times New Roman"><b> First&nbsp;Name:</b></font></div></td>
    <td width="192">
      
        <input name="t1" type="text" id="t1" onChange="return fnam()">    </td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Times New Roman"><strong>Last name:</strong></font></div></td>
    <td><input name="t2" type="text" id="t2" onChange="return lnam()" ></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Times New Roman"><b>&nbsp;Gender:</b> </font></div></td>
  ...
  <tr>
    <td><div align="center"><font size="+1" face="Times New Roman"><b>&nbsp;Enter Email : </b></font></div></td>
    <td><input name="t3" type="text" id="t3" onChange="return email()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Times New Roman"><b>&nbsp;Choose a  Password:</b> </font></div></td>
    <td><input name="p1" type="text" id="p1" onChange="return pass()"></td>
  </tr>
  <tr> <td><div align="center"><font size="+1" face="Times New Roman"><b>Phone no: </b></font></div></td>
    <td><input name="t5" type="text" id="t5" onChange="return phone()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Times New Roman"><strong>Address:</strong></font></div></td>
    <td><label>
      <textarea name="t6" id="t6" value="return add()"></textarea>
    </label></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Times New Roman"><strong>City:</strong></font></div></td>
    <td><input name="t7" type="text" id="t7" onChange="return city()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="Times New Roman"><strong>Country:</strong></font></div></td>
    <td><input name="t8" type="text" id="t8" onChange="return coun()"></td>
  </tr>
  <tr>
    <td><div align="center"><strong><font size="+1" face="Times New Roman">Date of Birth: </font></strong></div></td>
    <td><label>
